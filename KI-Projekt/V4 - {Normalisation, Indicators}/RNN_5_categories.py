...
def preprocessing(df):
    ...
    def sequentialise(df):
        ...
        for i in df.values:
            ...
            if len(prev_days) == SEQ_LEN and i[-1] != -1:
...
model.add(LSTM(128, input_shape=(train_x.shape[1:])))#,return_sequences=True    ,kernel_regularizer = l1(0.001)
