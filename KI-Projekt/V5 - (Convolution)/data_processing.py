...
train_loader = DataLoader(train_data, batch_size=BATCH_SIZE, shuffle=True, transform=ToTensor())
valid_loader = DataLoader(valid_data, batch_size=BATCH_SIZE, shuffle=True, transform=ToTensor())
